...
export function forward_to(obj, next) {
  ...
  var _loop = function _loop(k) {
    var _obj$k = _slicedToArray(obj[k], 2),
        update_fn = _obj$k[0],
        child_key = _obj$k[1];
    ...
    o[k] = function (model) {
      console.log("MODEL:", model, "this:", _this);
      return forward_msg(model, child_key, arguments.length <= 1 ? undefined : arguments[1], msg_maker, update_fn, _this.logger);
    };
  };
